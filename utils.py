...
def plot_all_levels(titles = 'Multiscale PHATE', levels = [], mp_op = None, PROJECT_DIR="/home/shuangni/AlzheimerProject"): 
    ...
    for i in range(len(levels)-1): 
        embedding, clusters, sizes = mp_op.transform(visualization_level = levels[i+1], cluster_level = levels[i+1])
        ...
        plt.savefig(PROJECT_DIR + '/figures/'+ titles +'_all_fig_level_%s'%levels[i+1] +'.jpg')
